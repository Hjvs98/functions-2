...
// */
// const allOrderTotals = orders.map((order) => order.price * (1 + order.tax));
// //console.log(allOrderTotals);
...
//examples and more practice for call backs
...
// const calculations = (num1, cb) => {
//      num1 + 10;

//   cb(num1);
// };
// calculations(36, (finalNum) => {
//   console.log(`Your final total is ${finalNum}`)
// );
